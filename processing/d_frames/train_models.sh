...
then
	python repo/processing/d_frames/cat.py --part train_models
elif [ "$SGE_TASK_ID" == 3 ]
then
	python repo/processing/d_frames/thread.py --part train_models
elif [ "$SGE_TASK_ID" == 4 ]
then
	python repo/processing/d_frames/arrival.py --part train_models
elif [ "$SGE_TASK_ID" == 5 ]
then
	python repo/processing/d_frames/delay.py --part train_models
elif [ "$SGE_TASK_ID" == 6 ]
then

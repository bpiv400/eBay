...
\begin{frame}{Seller experience predicts value}
	\begin{figure}
		\centering
		\includegraphics[height=.9\textheight]{{values/response_slrbo}.png}
	\end{figure}
\end{frame}
...
\begin{frame}{Listings with more photos generally have higher values}
	\begin{figure}[h]
    	\centering
		\includegraphics[height=.8\textheight]{\detokenize{values/coef_photovals.png}}
	\end{figure}
\end{frame}
...
\begin{frame}{Values $(\delta = 0.67)$}
	\begin{figure}
		\centering
		\includegraphics[height=.8\textheight]{{slrvals/pdf_values}.png}
	\end{figure}
\end{frame}
...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.49\textwidth}
		...
		\includegraphics[width=6cm]{{slr2/response_reject}.png}
	\end{subfigure}
\end{figure}
...
%		\includegraphics[width=6cm]{{slr2/response_salenorm_Active}.png}
%	\end{subfigure}
%\end{figure}
%\end{frame}
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.49\textwidth}
		...
		\includegraphics[width=5cm]{{slrvals/pdf_unsoldvals}.png}
	\end{subfigure}
	\begin{subfigure}[t]{0.49\textwidth}
		\centering\caption{Sold items}
		\includegraphics[width=5cm]{{slrvals/pdf_soldvals}.png}
	\end{subfigure}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.49\textwidth}
		...
		\includegraphics[width=6cm]{{slr2/contour_rejdata}.png}
	\end{subfigure}
	\begin{subfigure}[t]{0.49\textwidth}
		\centering\caption{Agent}
		\includegraphics[width=6cm]{{slr2/contour_rejagent}.png}
	\end{subfigure}
\end{figure}
\end{frame}

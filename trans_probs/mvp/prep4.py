...
def main():
    ...
    leaves time features for all observed offers, leaves frac_remain features
    for all observed offers, adds feature for time of day (morning, afternoon, evening, night),

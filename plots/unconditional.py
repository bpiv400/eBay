...
from constants import PLOT_DIR, BYR_HIST_MODEL, \
    HOUR, DAY, MAX_DELAY_TURN, MAX_DELAY_ARRIVAL, INTERVAL_ARRIVAL
from featnames import CON, MSG, DELAY, SIM, OBS, ARRIVAL
...
def draw_arrival(p, suffix=''):
    ...
    xticks = np.arange(0, MAX_DELAY_ARRIVAL / DAY, 3)

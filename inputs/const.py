...
INTERVAL_TURN = 5 * MINUTE
INTERVAL_ARRIVAL = HOUR

INTERVAL_COUNT_TURN = MAX_DELAY_TURN / INTERVAL_TURN
INTERVAL_COUNT_ARRIVAL = MAX_DELAY_ARRIVAL / INTERVAL_ARRIVAL
